	...
	if(! is_a ($client, "Google_Client")){
		...
		<script>
			...
			function get_times(date_picker){
				...
				xhttp.open('GET', 'http://localhost:8888/Group3.github.io/calendar/calendar.php?action=get_times&date='+date+'&t=' + Math.random());
			...
			function createEvent(btn){
				...
				xhttp.onreadystatechange = function(){
					if(this.readyState == 4 && this.status == 200){
						...
						window.location = 'http://localhost:8888/Group3.github.io/calendar/';
			...
			function delete_me(btn){
				...
				xhttp.open('GET', 'http://localhost:8888/Group3.github.io/calendar/calendar.php?action=delete_me&del_id='+del_id);
